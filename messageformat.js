...
(function (exports) {
  ...
  MessageFormat.Utils = {
    numSub : function ( string, d, key, offset ) {
      ...
      var s = string.replace( /(^|[^\\])#/g, '$1"+methods.n(' + d + ',' + key + (offset ? ',' + offset : '') + ')+"' );
  ...
  MessageFormat.prototype.precompile = function ( ast, methods ) {
    var self = this,
      needOther = false;
    ...
    function interpMFP ( ast, data ) {
      ...
      switch ( ast.type ) {
        ...
        case 'messageFormatElement':
          ...
          if ( ast.output ) {
            return 'methods.v(d,"' + ast.argumentIndex + '")';
          }
          else {
        ...
        case 'elementFormat':
          if ( ast.key === 'select' ) {
            return 'methods.s(d,' + data.keys[data.pf_count] + ',' + interpMFP( ast.val, data ) + ')';
          }
          else if ( ast.key === 'plural' ) {
            data.offset[data.pf_count || 0] = ast.val.offset || 0;
            return 'methods.p(d,' + data.keys[data.pf_count] + ',' + (data.offset[data.pf_count] || 0)
  ...
  MessageFormat.prototype.compile = function ( message ) {
    return (new Function( 'MessageFormat', 'methods',
      'return ' +
      this.precompile(
        this.parse( message ),
        methods
