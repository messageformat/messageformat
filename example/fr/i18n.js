...
pf={"fr":function(n,ord) { if (ord) return (n == 1) ? 'one' : 'other'; return (n >= 0 && n < 2) ? 'one' : 'other'; }},
fmt={};
...
"sub/folder/plural":{
test:function(d){return p(d["NUM"],0,pf["fr"],{one:"Votre message se trouve",other:"Vos messages se trouvent"})+" ici."}}}
})(this);
