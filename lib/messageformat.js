  ...
  switch ( ast.type ) {
    ...
    case 'elementFormat':
      ...
      switch (ast.key) {
        ...
        case 'selectordinal':
          args = args.concat([ 0, funcname(lc), this._precompile(ast.val, lc, data), 1 ]);
          this._rt.mf.plural = true;
          this._rt.pf[lc] = true;
          return 'plural(' + args.join(', ') + ')';
        case 'plural':
          data.offset[data.pf_count || 0] = ast.val.offset || 0;
          args = args.concat([ data.offset[data.pf_count] || 0, funcname(lc), this._precompile(ast.val, lc, data) ]);
          this._rt.mf.plural = true;
          this._rt.pf[lc] = true;
          return 'plural(' + args.join(', ') + ')';
        default:
          ...
          return propname(ast.key, 'fmt') + '(' + args.join(', ') + ')';
      }
