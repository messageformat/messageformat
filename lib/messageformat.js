...
function MessageFormat(locale, formatters) {
  ...
  this.runtime = new Runtime(formatters);
}
 ...
 *
 * @class
 * @param {Object.<string,function>} [pluralFuncs] - A map of locales to their pluralization functions
 * @param {Object.<string,function>} [formatters] - Optional custom formatting functions  */
function Runtime(formatters) {
  this.fmt = formatters || {};
}
...
Runtime.prototype = {
  ...
  toString: function(pluralFuncs) {
    ...
    return _stringify({ pluralFuncs: pluralFuncs || {} }, 0) + _stringify(this, 0);
  }
};
...
MessageFormat.prototype.compile = function(messages, locale) {
  ...
  if (typeof messages != 'object') {
    var fn = new Function(
        ...
        'return ' + obj);
    var rt = this.runtime;
    return fn(rt.number, rt.plural, rt.select, pf, rt.fmt);
  }

  var rtStr = this.runtime.toString(pf) + '\n';
