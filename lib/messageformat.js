...
MessageFormat.runtime = {
  ...
  /** @private */
  toString: function(pluralFuncs, fmt) {
    ...
    var self = { pluralFuncs: pluralFuncs || {} };
    if (fmt && Object.keys(fmt).length) self.fmt = fmt;
    return _stringify(self, 0) + _stringify(MessageFormat.runtime, 0);
  }
};
 ...
 *  with special handling for `exports` and `module.exports`.
 *
...
MessageFormat.prototype.compile = function(messages, locale) {
  ...
  var rtStr = MessageFormat.runtime.toString(pf, this.fmt) + '\n';
