 ...
 *
 * If `src` is an object with a key that is also present in `pluralFuncs`, the
 * key in question will be used as the locale identifier for its value.
 *
 * @param {string|object} src - the source for which the JS code should be generated
 * @param {string} lc - the default locale
 * @param {object} pluralFuncs - a map of available pluralization functions
 */
