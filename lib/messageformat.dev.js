      ...
      switch ( ast.type ) {
        ...
        case 'messageFormatElement':
          ...
          if ( ast.output ) {
            ...
            data.key = '"' + ast.argumentIndex + '"';
            s += 'var k_'+(data.pf_count+1)+'=d['+data.key+'];\n';
        ...
        case 'elementFormat':
          if ( ast.key === 'select' ) {
            ...
            s += interpMFP( ast.val, data );
            s += 'r += MessageFormat.plural(pf_' + data.pf_count + ',k_' + (data.pf_count+1)
              + ',off_' + data.pf_count + ',d,"' + self.fallbackLocale + '");\n';
          }
          return s;
        /* // Unreachable cases.
        case 'pluralStyle':
