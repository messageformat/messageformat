...
function Get(locales, defaultLocale) {
  ...
  Object.defineProperty(this, 'locale', {
    ...
    set: function(lc) { this._locale = _getLC(this._data, lc); }
  });
  ...
  Object.defineProperty(this, 'defaultLocale', {
    ...
    set: function(lc) { this._defaultLocale = _getLC(this._data, lc); }
  });
...
/** @private */
function _getLC(data, lc) {
  if (data[lc]) return lc;
  if (lc) {
    var l = String(lc);
    while (l = l.replace(/[-_]?[^-_]*$/, '')) {
      if (data[l]) return l;
    }
    var ll = Object.keys(data);
