...
|  onError | (err: [DateFormatError](./date-skeleton.dateformaterror.md)<!-- -->) =&gt; void | If defined, will be called separately for each encountered parsing error and unsupported feature. |
