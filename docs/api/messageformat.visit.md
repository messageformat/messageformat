...
|  visitors | { annotation?: (annotation: [FunctionAnnotation](./messageformat.functionannotation.md) \| [UnsupportedAnnotation](./messageformat.unsupportedannotation.md)<!-- -->, context: 'declaration' \| 'selector' \| 'placeholder', argument: [Literal](./messageformat.literal.md) \| [VariableRef](./messageformat.variableref.md) \| undefined) =&gt; (() =&gt; void) \| void; attribute?: (attr: [Attribute](./messageformat.attribute.md)<!-- -->, index: number, attributes: [Attribute](./messageformat.attribute.md)<!-- -->\[\], context: 'declaration' \| 'selector' \| 'placeholder') =&gt; (() =&gt; void) \| void; declaration?: (declaration: [Declaration](./messageformat.declaration.md)<!-- -->) =&gt; (() =&gt; void) \| void; expression?: (expression: [Expression](./messageformat.expression.md)<!-- -->, context: 'declaration' \| 'selector' \| 'placeholder') =&gt; (() =&gt; void) \| void; key?: (key: [Literal](./messageformat.literal.md) \| [CatchallKey](./messageformat.catchallkey.md)<!-- -->, index: number, keys: ([Literal](./messageformat.literal.md) \| [CatchallKey](./messageformat.catchallkey.md)<!-- -->)\[\]) =&gt; void; markup?: (markup: [Markup](./messageformat.markup.md)<!-- -->, context: 'declaration' \| 'placeholder') =&gt; (() =&gt; void) \| void; node?: (node: [MessageNode](./messageformat.messagenode.md)<!-- -->, ...rest: unknown\[\]) =&gt; void; option?: (option: [Option](./messageformat.option.md)<!-- -->, index: number, options: [Option](./messageformat.option.md)<!-- -->\[\], context: 'declaration' \| 'selector' \| 'placeholder') =&gt; (() =&gt; void) \| void; pattern?: (pattern: [Pattern](./messageformat.pattern.md)<!-- -->) =&gt; (() =&gt; void) \| void; value?: (value: [Literal](./messageformat.literal.md) \| [VariableRef](./messageformat.variableref.md)<!-- -->, context: 'declaration' \| 'selector' \| 'placeholder', position: 'arg' \| 'option' \| 'attribute') =&gt; void; variant?: (variant: [Variant](./messageformat.variant.md)<!-- -->) =&gt; (() =&gt; void) \| void; } |  |
